...
public class ServiceEntity {
  ...
  public boolean equals(Object o) {
    ...
    return !(address != null ? !address.equals(that.address) : that.address != null)
        && !(serviceMeta != null ? !serviceMeta.equals(that.serviceMeta)
            : that.serviceMeta != null);
  }
  ...
  public String toString() {
    return "RegisterMeta{" + "address=" + address + ", serviceMeta=" + serviceMeta + ", weight="
        + weight + ", connCount=" + connCount + '}';
  }
  ...
  public static class Address {
    ...
    public boolean equals(Object o) {
      ...
      return port == address.port
          && !(host != null ? !host.equals(address.host) : address.host != null);
    }
  ...
  public static class ServiceMeta {
    ...
    public boolean equals(Object o) {
      ...
      return !(group != null ? !group.equals(that.group) : that.group != null)
          && !(serviceProviderName != null ? !serviceProviderName.equals(that.serviceProviderName)
    ...
    @Override
    public String toString() {
      return "ServiceMeta{" + "group='" + group + '\'' + ", serviceProviderName='"
          + serviceProviderName + '\'' + ", version='" + version + '\'' + '}';
    }
  }
